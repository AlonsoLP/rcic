...
**RC Info Center (RCIC)** is a lightweight, fast, and highly optimized telemetry script designed for radio transmitters running **EdgeTX 2.9 or higher** (and compatible OpenTX). It provides a multifunctional tabbed dashboard, real-time configurable battery alerts, GPS coordinate validation, an integrated drone locator, and fast local QR Code generation.
...
* **Lost Drone Locator (LOC):** Acoustic (Geiger-counter style) and visual RSSI tracker to find your downed quadcopter, compatible with ELRS, Crossfire, and FrSky.
...
📖 **For detailed instructions, feature breakdowns, and configuration guides, please visit the [RCIC GitHub Wiki](../../wiki).**
